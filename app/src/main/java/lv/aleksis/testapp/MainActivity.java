...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView courseNameTV, courseTracksTV, courseBatchTV, division;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String courseName = response.getString("full_name");
                    String courseTracks = response.getString("abbreviation");
                    String courseMode = response.getString("city");
                    String coursDiv = response.getString("division");
